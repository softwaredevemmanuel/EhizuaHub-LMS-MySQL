  ...
  useEffect(() => {
    async function fetchCourseCurriculum() {
        try {
          ...
          const response = await axios.get('http://localhost:5000/api/school-tutor/school-course-curriculum', {
            headers: {
...
export default ViewSchoolCurriculum;
