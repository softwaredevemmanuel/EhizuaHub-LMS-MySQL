  ...
  useEffect(() => {
    async function fetchCourseContent() {
        try {
          ...
          const response = await axios.get('http://localhost:5000/api/tutor/school-course-content-list', {
            headers: {
          ...
          <div key={mainIndex}>
            ...
            {content
              ...
              .map((subContent, subIndex) => (
                <div key={subIndex}>
                  <a href={`/school-course-content-details/${subContent.id}`}>
...
export default ViewSchoolCourseList;
